...
1. É requisito necessário ter instalados na máquina tanto o NodeJS como o NPM.
   Para informações sobre a instalação dos mesmos consulte o link abaixo: 
...
4. Rode o comando abaixo para instalar as dependências:
  `$ npm install`

5. Rode o comando abaixo para subir o servidor Node:
  `$ npm start`
...
1. Criei um modeloo Business Canvas para um possível aprimoramento deste projeto.
   A ideia pode ser vista na figura abaixo:

<p align="center">
  <img alt="BCancas" src="img/ecoleta-business-canvas.jpg" width="100%">
</p>

## :small_orange_diamond: Customizando

1. Uso de variáveis no CSS em todo o projeto para facilitar a customiação.
2. Implementação de tema DARK MODE para maior conforto visual.

## :small_orange_diamond: Licença

Esse projeto está sob a licença MIT. Veja o arquivo [LICENSE](LICENSE.md) para mais detalhes.
A(s) imagem(s) usadas neste projeto são originais do autor ou foram obtidas através do site da Pexels com a devida autorização para uso gratuito.

## :small_orange_diamond: Trello

<p align="center">
  <img alt="Trello" src="img/trello-ecoleta.jpg" width="100%">
</p>
...
Também agradeço ao Gabriel Oliveira do site OhMyCode (nome fantástico!) pelas explicações sobre Grid Layout e Dark Tema. 
